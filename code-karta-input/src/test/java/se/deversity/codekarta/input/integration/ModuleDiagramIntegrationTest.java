...
class ModuleDiagramIntegrationTest {
    ...
    void extractsShippingModuleNode() {
        assertNotNull(graph.findNode("se.deversity.codekarta.shipping"),
                "se.deversity.codekarta.shipping module node must be present");
        assertEquals("MODULE", graph.findNode("se.deversity.codekarta.shipping").getType());
    }
    ...
    void extractsRequiresEdges() {
        assertTrue(hasEdge("se.deversity.codekarta.shipping", "java.base",    "REQUIRES"), "must REQUIRE java.base");
        assertTrue(hasEdge("se.deversity.codekarta.shipping", "java.logging", "REQUIRES"), "must REQUIRE java.logging");
    }

    @Test
    void extractsExportedPackageNodes() {
        assertNotNull(graph.findNode("se.deversity.codekarta.shipping.domain"), "domain package must be exported");
        assertNotNull(graph.findNode("se.deversity.codekarta.shipping.core"),   "core package must be exported");
        assertNotNull(graph.findNode("se.deversity.codekarta.shipping.state"),  "state package must be exported");
        assertEquals("PACKAGE", graph.findNode("se.deversity.codekarta.shipping.domain").getType());
    }

    @Test
    void extractsExportsEdges() {
        assertTrue(hasEdge("se.deversity.codekarta.shipping", "se.deversity.codekarta.shipping.domain", "EXPORTS"));
        assertTrue(hasEdge("se.deversity.codekarta.shipping", "se.deversity.codekarta.shipping.core",   "EXPORTS"));
        assertTrue(hasEdge("se.deversity.codekarta.shipping", "se.deversity.codekarta.shipping.state",  "EXPORTS"));
    }
