 ...
 *
 * <ul>
 *   <li>Tiers communicate only through the Core IR ({@code com.karta.core.model}) —
...
public class ArchitectureRulesTest {
    ...
    static final ArchRule INPUT_DOES_NOT_DEPEND_ON_SIBLING_TIERS =
            noClasses()
                    .that().resideInAPackage("com.karta.input..")
                    .should().dependOnClassesThat()
                    .resideInAnyPackage("com.karta.layout..", "com.karta.render..", "com.karta.cli..")
    ...
    static final ArchRule LAYOUT_DOES_NOT_DEPEND_ON_SIBLING_TIERS =
            noClasses()
                    .that().resideInAPackage("com.karta.layout..")
                    .should().dependOnClassesThat()
                    .resideInAnyPackage("com.karta.input..", "com.karta.render..", "com.karta.cli..")
    ...
    static final ArchRule RENDER_DOES_NOT_DEPEND_ON_SIBLING_TIERS =
            noClasses()
                    .that().resideInAPackage("com.karta.render..")
                    .should().dependOnClassesThat()
                    .resideInAnyPackage("com.karta.input..", "com.karta.layout..", "com.karta.cli..")
    ...
    static final ArchRule CORE_DEPENDS_ON_NOTHING_ABOVE_IT =
            classes()
                    .that().resideInAPackage("com.karta.core..")
                    .should().onlyDependOnClassesThat()
                    .resideInAnyPackage("com.karta.core..", "java..", "com.fasterxml.jackson..",
    ...
    /** The whole com.karta hierarchy must stay free of package cycles. */
    @ArchTest
    static final ArchRule NO_PACKAGE_CYCLES =
            slices()
                    .matching("com.karta.(**)")
                    .should().beFreeOfCycles()
                    .as("com.karta packages must be free of circular dependencies");
}
