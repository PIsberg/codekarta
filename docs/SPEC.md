...
- Maven: `mvn clean package` → `code-karta-cli/target/code-karta-cli-0.2.0-all.jar`
- Gradle: `./gradlew :code-karta-cli:fatJar` → `code-karta-cli/build/libs/code-karta-cli-0.2.0-all.jar`
